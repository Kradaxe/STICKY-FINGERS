...
export const analyzeRepository = async (req, res) => {
    try {
        ...
        console.time("index");
        const repositoryIndex = await repositoryIndexService.build(snapshot.repositoryPath);
        console.timeEnd("index");
        repositoryCacheService.set(repoUrl, snapshot.repositoryPath, repositoryIndex);
